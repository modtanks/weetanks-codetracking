...
public class EnemyAI : MonoBehaviour
{
	...
	public bool StopPathfindingIfBeingTargeted = true;
	...
	private void MoveTank()
	{
		...
		if (HasPathfinding && hasGottenPath)
		{
			...
			if (StopPathfindingIfBeingTargeted)
			{
			...
			{
				if (isAggressive && StopPathfindingIfBeingTargeted && !isLevel100Boss && ETSN.TargetInSight && !GoingToPlayer)
				{
					DisablePathFinding();
				}
